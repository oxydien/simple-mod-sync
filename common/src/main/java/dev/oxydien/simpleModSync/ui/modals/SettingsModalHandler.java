    ...
    public static void open(Screen parentScreen) {
        ...
        var modal = new BasicModalWindow.Builder(title, parentScreen)
                ...
                .addBodyWidget((screen, mX, mY, mW, mH) -> {
                    ...
                    // Sync on game start
                    var syncOnStartupBox = Checkbox.builder(Component.translatable("simple_mod_sync.ui.modal.settings.sync_on_startup"), font)
                    ...
                    var allowSyncInProgressBox = Checkbox.builder(Component.translatable("simple_mod_sync.ui.modal.settings.allow_sync_in_progress_popup"), font)
                    ...
                    var allowGameNeedsRestartBox = Checkbox.builder(Component.translatable("simple_mod_sync.ui.modal.settings.allow_game_needs_restart_popup"), font)
                ...
                .withPrimaryButton(Component.translatable("simple_mod_sync.ui.modal.save"), (btn) -> {
                ...
                .withSecondaryButton(Component.translatable("simple_mod_sync.ui.modal.cancel"), ( btn) -> {
                    mc.setScreen(parentScreen);
                })
                .build();
